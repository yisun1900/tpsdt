...
public interface CommandConstants {
    ...
    List<HeatStructureRule> HEAT_STRUCTURE_RULES = Arrays.asList(
            //SUPER LOW =================================================================================================================
            new HeatStructureRule(NUM09 + "{1,8}", Math.pow(10, 6), "1到8位纯数字"),
            new HeatStructureRule(AZ_LOWER + "{1,8}", Math.pow(10, 6), "1到8位小写字母"),
            new HeatStructureRule(AZ_VOWEL + "{1,8}", Math.pow(10, 6), "1到8位元音字母"),
            new HeatStructureRule(AZ_HIGH + "{1,8}", Math.pow(10, 6), "1到8位大写字母"),
            new HeatStructureRule(SP + "{1,8}", Math.pow(10, 6), "1到8位特殊字母"),
