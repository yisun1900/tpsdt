...
public interface CommandConstants {
    ...
    List<HeatStructRule> HEAT_STRUCT_RULE = Arrays.asList(
            ...
            new HeatStructRule(5, AZ_VOWEL + "{5}", HeatStructStandard.LOW, 22),
            new HeatStructRule(5, AZ_HIGH + "{5}", HeatStructStandard.LOW, 23),
            new HeatStructRule(5, AZ_LOW + "{5}", HeatStructStandard.LOW, 24),
            new HeatStructRule(4, NUM09 + "{4}", HeatStructStandard.LOW, 25),
            new HeatStructRule(2, AZ_HIGH + AZ_VOWEL, HeatStructStandard.LOW, 26),
            new HeatStructRule(2, NUM09 + "{2}", HeatStructStandard.LOW, 27),
            ...
            new HeatStructRule(5, AZ_HIGH + AZ_VOWEL + AZ_HIGH + AZ_VOWEL + AZ_HIGH, HeatStructStandard.LOW, 35),
            new HeatStructRule(3, AZ_HIGH + AZ_VOWEL + "{2}", HeatStructStandard.LOW, 36),
            new HeatStructRule(2, AZ_HIGH + AZ_LOW, HeatStructStandard.LOW, 37),
            new HeatStructRule(2, AZ_VOWEL + AZ_LOW, HeatStructStandard.LOW, 38),
            new HeatStructRule(3, NUM09 + "{2}", HeatStructStandard.LOW, 39),
            new HeatStructRule(3, AZ_LOW + AZ_VOWEL + AZ_HIGH, HeatStructStandard.LOW, 40),
            //MEDIUM===================================================================================================================
            new HeatStructRule(1, NUM09, HeatStructStandard.MEDIUM, 41),
            new HeatStructRule(1, AZ_VOWEL, HeatStructStandard.MEDIUM, 42),
            new HeatStructRule(1, AZ_HIGH, HeatStructStandard.MEDIUM, 43),
            new HeatStructRule(1, AZ_LOW, HeatStructStandard.MEDIUM, 44),
            new HeatStructRule(4, NUM09 + "{4}", HeatStructStandard.MEDIUM, 45),
            new HeatStructRule(2, AZ_HIGH + AZ_VOWEL, HeatStructStandard.MEDIUM, 46),
            new HeatStructRule(2, NUM09 + "{2}", HeatStructStandard.MEDIUM, 47),
            new HeatStructRule(5, NUM09 + "{5}", HeatStructStandard.MEDIUM, 48),
            new HeatStructRule(3, AZ_HIGH + AZ_VOWEL + AZ_HIGH, HeatStructStandard.MEDIUM, 49),
            new HeatStructRule(2, AZ_LOW + AZ_VOWEL, HeatStructStandard.MEDIUM, 50),
            new HeatStructRule(6, NUM09 + "{6}", HeatStructStandard.MEDIUM, 51),
            new HeatStructRule(4, AZ_HIGH + AZ_VOWEL + AZ_HIGH + AZ_VOWEL, HeatStructStandard.MEDIUM, 52),
            new HeatStructRule(2, AZ_HIGH + "{2}", HeatStructStandard.MEDIUM, 53),
            new HeatStructRule(3, AZ_VOWEL + AZ_HIGH + AZ_VOWEL, HeatStructStandard.MEDIUM, 54),
            new HeatStructRule(5, AZ_HIGH + AZ_VOWEL + AZ_HIGH + AZ_VOWEL + AZ_HIGH, HeatStructStandard.MEDIUM, 55),
            new HeatStructRule(3, AZ_HIGH + AZ_VOWEL + "{2}", HeatStructStandard.MEDIUM, 56),
            new HeatStructRule(2, AZ_HIGH + AZ_LOW, HeatStructStandard.MEDIUM, 57),
            new HeatStructRule(2, AZ_VOWEL + AZ_LOW, HeatStructStandard.MEDIUM, 58),
            new HeatStructRule(3, NUM09 + "{2}", HeatStructStandard.MEDIUM, 59),
            new HeatStructRule(3, AZ_LOW + AZ_VOWEL + AZ_HIGH, HeatStructStandard.MEDIUM, 60),
            //HIGH======================================================================================================================
            new HeatStructRule(1, NUM09, HeatStructStandard.HIGH, 71),
            new HeatStructRule(1, AZ_VOWEL, HeatStructStandard.HIGH, 72),
            new HeatStructRule(1, AZ_HIGH, HeatStructStandard.HIGH, 73),
            new HeatStructRule(1, AZ_LOW, HeatStructStandard.HIGH, 74),
            new HeatStructRule(4, NUM09 + "{4}", HeatStructStandard.HIGH, 75),
            new HeatStructRule(2, AZ_HIGH + AZ_VOWEL, HeatStructStandard.HIGH, 76),
            new HeatStructRule(2, NUM09 + "{2}", HeatStructStandard.HIGH, 77),
            new HeatStructRule(5, NUM09 + "{5}", HeatStructStandard.HIGH, 78),
            new HeatStructRule(3, AZ_HIGH + AZ_VOWEL + AZ_HIGH, HeatStructStandard.HIGH, 79),
            new HeatStructRule(2, AZ_LOW + AZ_VOWEL, HeatStructStandard.HIGH, 80),
            new HeatStructRule(6, NUM09 + "{6}", HeatStructStandard.HIGH, 81),
            new HeatStructRule(4, AZ_HIGH + AZ_VOWEL + AZ_HIGH + AZ_VOWEL, HeatStructStandard.HIGH, 82),
            new HeatStructRule(2, AZ_HIGH + "{2}", HeatStructStandard.HIGH, 83),
            new HeatStructRule(3, AZ_VOWEL + AZ_HIGH + AZ_VOWEL, HeatStructStandard.HIGH, 84),
            new HeatStructRule(5, AZ_HIGH + AZ_VOWEL + AZ_HIGH + AZ_VOWEL + AZ_HIGH, HeatStructStandard.HIGH, 85),
            new HeatStructRule(3, AZ_HIGH + AZ_VOWEL + "{2}", HeatStructStandard.HIGH, 86),
            new HeatStructRule(2, AZ_HIGH + AZ_LOW, HeatStructStandard.HIGH, 87),
            new HeatStructRule(2, AZ_VOWEL + AZ_LOW, HeatStructStandard.HIGH, 88),
            new HeatStructRule(3, NUM09 + "{2}", HeatStructStandard.HIGH, 89),
            new HeatStructRule(3, AZ_LOW + AZ_VOWEL + AZ_HIGH, HeatStructStandard.HIGH, 90),
            //SUPER HIGH==================================================================================================================
